...
Interval ReservationTable::get_first_safe_interval(size_t location, bool clear_intervals)
{
    if (clear_intervals)
        sit[location].clear();
...
bool ReservationTable::find_safe_interval(Interval& interval, size_t location, int t_min, bool clear_intervals)
{
    if (clear_intervals)
        sit[location].clear();
