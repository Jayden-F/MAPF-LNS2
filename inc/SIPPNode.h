...
class SIPPNode : public LLNode {
  public:
    ...
    SIPPNode(int loc, int g_val, int h_val, SIPPNode *parent, int timestep,
        ...
        : LLNode(loc, g_val, h_val, parent, timestep, num_of_conflicts),
          high_generation(high_generation), high_expansion(high_expansion),
    ...
    struct NodeHasher {
        std::size_t operator()(const SIPPNode *n) const {
            ...
            boost::hash_combine(seed, n->interval->second.high);
            return seed;
        }
    };
        ...
        bool operator()(const SIPPNode *n1, const SIPPNode *n2) const {
            return (n1 == n2) ||
                   (n1 && n2 && n1->location == n2->location &&
                    ...
                    n1->interval->second.high == n2->interval->second.high);
