...
public:
    ...
    ReservationTable(const ConstraintTable& constraint_table, int goal_location, SIT& sit) :
        constraint_table(constraint_table), goal_location(goal_location), sit(sit) {}
