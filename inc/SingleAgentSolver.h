...
public:
    ...
    virtual Path findPath(const ConstraintTable& constraint_table, int depth_limit = MAX_TIMESTEP, int t_min = 0) = 0;  // return the path
	virtual Path findPath(ReservationTable& reservation_table, int depth_limit = MAX_TIMESTEP, int t_min = 0) = 0;  // return the path
