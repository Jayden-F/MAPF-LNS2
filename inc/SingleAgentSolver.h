...
public:
	...
	virtual Path findPath(ReservationTable& constraint_table, MemoryPool& memory_pool, int planning_window_length = INFINITY){Path path; return path;}  // return the path
